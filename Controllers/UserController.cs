...
namespace Inventario.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<ActionResult<User>> SeedRoles([FromBody] UpdatePermissionDto updatePermissionDto)
        {
            ...
            _auditoriaService.RegistrarAuditoria("Usuario", userName , "Agregar", "Se ha registrado un nuevo usuario");
            return Ok(seerRoles);
        ...
        public async Task<IActionResult> Put(int id, [FromBody] UserCreateDTO user)
        {
            ...
            try
            {
                ...
                string userName = User.Identity.Name;
                _auditoriaService.RegistrarAuditoria("Usuario", userName , "Editar", "Se han editado los datos de un usuario");
        ...
        public async Task<ActionResult<User>> Delete(int id)
        {
            ...
            string userName = User.Identity.Name;
            _auditoriaService.RegistrarAuditoria("Usuario", userName , "Eliminar", "Se ha eliminado un usuario");
